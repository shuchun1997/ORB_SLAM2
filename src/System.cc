...
namespace ORB_SLAM2
{
//首先是词典文件， 第二个参数是相机参数文件。第三个参数是用ORB_SLAM2::System::MONOCULAR初始化mSensor。其余的参数不用太在意，已经用默认的参数进行初始化了。
        ...
        mbDeactivateLocalizationMode(false)
{
    ...
    //Initialize the Loop Closing thread and launch(初始化Local Mapping线程并开启线程运行)
...
void System::SaveTrajectoryTUM(const string &filename)   //保存轨迹函数实现
{
